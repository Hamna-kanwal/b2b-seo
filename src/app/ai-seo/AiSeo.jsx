        ...
        <div className="max-w-[1280px] w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 max-w-[700px]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <button
                onClick={openAudit}
                className="w-full sm:w-auto bg-[#8A2BE2] text-white font-[700] text-[16px] px-7 py-3.5 rounded-[16px] hover:bg-opacity-90 transition-all text-center shadow-md cursor-pointer"
              >
                Get a Free AI Visibility Check
              </button>
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto bg-transparent text-white font-[600] text-[16px] px-7 py-3.5 border border-white rounded-[16px] hover:bg-white/10 transition-colors text-center"
              >
                Speak to an AI SEO Specialist
              </Link>
            </div>
