...
export default function B2bSeo() {
  ...
  return (
<main className="min-h-screen bg-gradient-to-b from-[#180727] to-[#4C187C] flex flex-col items-center text-white font-sans overflow-hidden pt-24 md:pt-28">      {/* HERO SECTION */}
        ...
        <div className="max-w-[1280px] w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 max-w-[700px]">
            ...
            <p className="text-[16px] md:text-[18px] font-[500] leading-relaxed text-white/90">
              ...
              keywords and high-value deals where one qualified enquiry is worth
              more than ten thousand random visits. Senior-led, fully managed,
              and measured on leads.
            </p>
