...
<section className="relative w-full flex flex-col lg:flex-row items-center justify-between px-6 sm:px-12 md:px-20 pt-12 md:pt-20 pb-16 md:pb-24 z-10 gap-12 max-w-[1400px] mx-auto">
  ...
  {/* Content Container */}
  <div className="flex-1 max-w-[650px] text-center lg:text-left space-y-6">
    ...
    <p className="max-w-2xl text-base sm:text-lg font-normal text-purple-200/80 leading-relaxed mx-auto lg:mx-0">
