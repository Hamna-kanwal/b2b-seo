...
import FinancialFaq from "@/components/FinancialFaq";
import AuditForm from "@/components/AuditForm";

const benefits = [
  {
    title: "Trust decides finance rankings",
    desc: "Google holds money pages to its highest bar. Building credibility now pays off across every page.",
  },
  {
    title: "Compliance ready content is rare",
    desc: "Few SEO providers write within FCA rules. Firms that solve this now get ahead while others stall.",
  },
  {
    title: "Buyers research deeply",
    desc: "Financial buyers read before they commit. The firm that answers best earns the enquiry.",
  },
  {
    title: "AI is entering finance search",
    desc: "People now ask AI for advisers and products. Firms with clear signals get named first.",
  },
];
const cards = [
  {
    title: "Audit",
    description:
      "We audit your site, rankings, and the products worth ranking for.",
    isDark: true,
  },
  {
    title: "Build the pages",
    description: "We draft pages within FCA rules and your compliance process.",
    isDark: false,
  },
  {
    title: "Trust & profiles",
    description: "We add adviser profiles and the signals Google expects.",
    isDark: true,
  },
  {
    title: "Authority building",
    description: "We earn links and mentions so pages have the trust to rank.",
    isDark: false,
  },
  {
    title: "Track & refine",
    description: "We report on rankings and enquiries each month.",
    isDark: true,
  },
];
const services = [
  {
    ...
    desc: "A page for each product, written within FCA rules.",
    icon: "/images/1.png",
  },
  {
    title: "Adviser & firm profiles",
    desc: "Credentials shown, to build trust.",
    icon: "/images/2.png",
  },
  {
    title: "Credentials shown, to build trust.",
    desc: "Content approved through your sign off before it goes live.",
    icon: "/images/3.png",
  },
  {
    title: "Depth content",
    desc: "Answers to the questions clients ask before they buy.",
    icon: "/images/4.png",
  },
  {
    title: "Trust & technical",
    desc: "Schema and signals Google expects for money pages.",
    icon: "/images/5.png",
  },
  {
    title: "AI SEO",
    desc: "Structure that gets your firm named when people ask AI for options.",
    icon: "/images/6.png",
  },
];
const industries = [
        ...
        <div className="max-w-[1280px] w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 max-w-[700px]">
            ...
            <h1 className="text-[32px] md:text-[52px] lg:text-[56px] font-[800] leading-[1.12] tracking-tight text-[#0A0C10]">
              ...
              <span className="text-[#8A2BE2]"> enquiries</span>, within
              the rules
            </h1>
            {/* Subtext */}
            <p className="text-[16px] md:text-[18px] font-[500] leading-relaxed text-[#0A0C10]/70">
              Financial buyers research carefully, and every promotion has to
              meet FCA rules. We build product and adviser pages, trust content,
              and AI ready copy to the standard a regulated, high trust field
              demands, so search brings you qualified enquiries.
            </p>
            {/* CTA Buttons */}
        ...
        <div className="max-w-[1050px] w-full flex flex-col items-start">
          <div className="max-w-[750px] mb-10 space-y-2.5 text-left">
            ...
            <h2 className="text-[28px] md:text-[40px] font-bold text-[#0A0C10] tracking-tight">
              A generalist ranks pages. A specialist earns trust.
            </h2>
            <p className="text-[15px] md:text-[16px] text-[#0A0C10]/70 leading-relaxed">
              Financial search is high trust, high value, and strictly
              regulated. A generic approach ignores the FCA rules and the
              credibility Google expects. The work has to be written within
              financial promotion rules, built to the trust bar, and deep enough
              to answer careful buyers.
            </p>
          </div>
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="bg-white border border-[#8A2BE2]/20 text-[#0A0C10] p-6 rounded-[14px] flex flex-col justify-start space-y-4 shadow-sm">
              ...
              <ul className="space-y-3 text-[13.5px] md:text-[14.5px] font-normal text-[#0A0C10]/80">
                <li className="flex items-start">
                  ...
                  <span>Writes promotions with no eye on FCA rules</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span> Treats finance like any other topic</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span> Fights your compliance process</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Chases volume, not qualified enquiries</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#120524] text-white p-6 rounded-[14px] flex flex-col justify-start space-y-4 shadow-xl">
              <h3 className="text-[18px] font-bold tracking-tight text-white">
                A specialist for finance (Teqnoor)
              </h3>
              ...
              <ul className="space-y-2.5 text-[14px] md:text-[14.5px] font-normal opacity-90">
                <li className="flex items-start">
                  ...
                  <span>Copy written within FCA promotion rules</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Content built to the trust bar finance demands</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Pages that fit your compliance sign off</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Focused on qualified, high value enquiries</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-[1360px] w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start z-10">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-4 text-left">
            ...
            <p className="text-white/90 text-base md:text-lg max-w-md leading-relaxed font-normal pt-1">
              Built around how clients research money decisions, and the rules a
              regulated field must follow.
            </p>
          </div>
        ...
        <div className="max-w-[1240px] mx-auto flex flex-col items-start text-left">
          ...
          <div className="mb-10 space-y-3">
            ...
            <h2 className="text-[32px] md:text-[44px] font-bold text-[#0A0C10] tracking-tight">
              SEO for firms across financial services{" "}
            </h2>
            <p className="text-base md:text-lg text-[#0A0C10]/70 max-w-2xl leading-relaxed">
              We work with UK financial firms that want qualified enquiries from
              a field where trust decides who wins.
            </p>
          </div>
      ...
      <section className="w-full bg-[#F9F3FF] py-20 px-6 md:px-12">
        <div className="max-w-[1240px] mx-auto flex flex-col items-start text-left">
          ...
          <div className="mb-14 space-y-3">
            ...
            <h2 className="text-[32px] md:text-[44px] font-bold text-[#0A0C10] tracking-tight">
              Why Financial Services SEO can't wait
            </h2>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[36px] bg-[#06060B] px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            <div className="relative z-10 max-w-[850px] mx-auto flex flex-col items-center">
              <h2 className="text-white text-[26px] md:text-[42px] font-bold leading-[1.2] tracking-[-0.03em] mb-5">
                See which financial searches your firm is missing{" "}
              </h2>

              <p className="text-[#B7B7C2] text-[15px] md:text-[18px] leading-relaxed mb-10">
                Get a free SEO review. We will show you the product and adviser
                searches you could rank for, and where rivals are winning the
                enquiries.{" "}
              </p>
