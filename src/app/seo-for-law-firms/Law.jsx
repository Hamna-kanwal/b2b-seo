...
const benefits = [
  {
    title: "Cases are high value",
    desc: "A single ranking can return the cost many times over. The firms that rank first take the best enquiries.",
  },
  {
    title: "Practice area slots are being claimed",
    desc: "Competitors are building pages for each service now. The top spots fill up and are hard to take back.",
  },
  {
    title: "Trust decides legal rankings",
    desc: "Google holds legal advice to its highest bar. Building credibility now pays off across every page.",
  },
  {
    title: "AI is entering legal search",
    desc: "People now ask AI for a solicitor. Firms with clear trust signals get named first.",
  },
];
const cards = [
  {
    title: "Audit",
    description:
      "We audit your site, rankings, and the practice areas worth ranking for.",
    isDark: true,
  },
  {
    title: "Build the pages",
    description: "We build a page for each practice area and location.",
    isDark: false,
  },
  {
    title: "Trust & compliance",
    description:
      "We add solicitor profiles and keep every claim within SRA rules.",
    isDark: true,
  },
  {
    title: "Authority building",
    description:
      "We earn links and reviews so the pages have the trust to rank.",
    isDark: false,
  },
  {
    title: "Track & refine",
    description: "We report on rankings and case enquiries each month.",
    isDark: true,
  },
];
const services = [
  {
    ...
    desc: "Conveyancing, family, personal injury, employment, each on its own page.",
    icon: "/images/1.png",
  },
  {
    title: "Local pages",
    desc: "Pages for the towns and regions you serve.",
    icon: "/images/2.png",
  },
  {
    title: "Solicitor profiles",
    desc: "Credentials shown, so clients and Google trust the advice.",
    icon: "/images/3.png",
  },
  {
    title: "Review & reputation",
    desc: "Signals that clients and Google both weigh.",
    icon: "/images/4.png",
  },
  {
    title: "Regulated, accurate copy",
    desc: "Claims kept within SRA advertising rules.",
    icon: "/images/5.png",
  },
  {
    title: "AI SEO",
    desc: "Structure that gets your firm named when people ask AI for legal help.",
    icon: "/images/6.png",
  },
];
const industries = [
        ...
        <div className="max-w-[1280px] w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8 max-w-[700px]">
            ...
            <p className="text-[16px] md:text-[18px] font-[500] leading-relaxed text-[#0A0C10]/70">
              Clients look for a legal service and a location together, like
              "conveyancing solicitor" plus a town. We build practice area
              pages, local signals, and the trust content a regulated field
              needs to turn those searches into case enquiries.{" "}
            </p>
        ...
        <div className="max-w-[1050px] w-full flex flex-col items-start">
          <div className="max-w-[750px] mb-10 space-y-2.5 text-left">
            ...
            <h2 className="text-[28px] md:text-[40px] font-bold text-[#0A0C10] tracking-tight">
              A generalist ranks pages. A specialist wins cases.
            </h2>

            <p className="text-[15px] md:text-[16px] text-[#0A0C10]/70 leading-relaxed">
              Legal search is practice area led, local, high value, and strictly
              regulated. A generic approach treats a law firm like any other
              business. The work has to match each practice area, keep every
              claim within SRA rules, and meet the trust bar Google sets for
              legal advice.
            </p>
          </div>
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div className="bg-white border border-[#8A2BE2]/20 text-[#0A0C10] p-6 rounded-[14px] flex flex-col justify-start space-y-4 shadow-sm">
              ...
              <ul className="space-y-3 text-[13.5px] md:text-[14.5px] font-normal text-[#0A0C10]/80">
                <li className="flex items-start">
                  ...
                  <span>One services page for every practice area</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>No grasp of SRA advertising rules</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Treats legal advice like ordinary content</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Chases traffic, not case value</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#120524] text-white p-6 rounded-[14px] flex flex-col justify-start space-y-4 shadow-xl">
              <h3 className="text-[18px] font-bold tracking-tight text-white">
                A specialist for law firms (Teqnoor)
              </h3>
              ...
              <ul className="space-y-2.5 text-[14px] md:text-[14.5px] font-normal opacity-90">
                <li className="flex items-start">
                  ...
                  <span>A page for each practice area and location</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  </span>
                  <span>Claims kept accurate and within SRA rules</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                    •
                  ...
                  <span>
                    Content written to the trust bar legal advice demands
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2.5 select-none text-[#8A2BE2] font-bold">
                  ...
                  <span>Focused on high value case enquiries</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-[1360px] w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start z-10">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-4 text-left">
            ...
            <p className="text-white/90 text-base md:text-lg max-w-md leading-relaxed font-normal pt-1">
              Built around how clients search for a solicitor, and the rules a
        ...
        <div className="max-w-[1240px] mx-auto flex flex-col items-start text-left">
          ...
          <div className="mb-10 space-y-3">
            ...
            <h2 className="text-[32px] md:text-[44px] font-bold text-[#0A0C10] tracking-tight">
              SEO for firms across every practice area{" "}
            </h2>
            <p className="text-base md:text-lg text-[#0A0C10]/70 max-w-2xl leading-relaxed">
              We work with UK solicitors and law firms that want a steady flow
              of high value case enquiries.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[36px] bg-[#06060B] px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            <div className="relative z-10 max-w-[850px] mx-auto flex flex-col items-center">
              <h2 className="text-white text-[26px] md:text-[42px] font-bold leading-[1.2] tracking-[-0.03em] mb-5">
                See which case enquiries your firm is missing{" "}
              </h2>

              <p className="text-[#B7B7C2] text-[15px] md:text-[18px] leading-relaxed mb-10">
                Get a free SEO review. We will show you the practice area and
                local searches you could rank for, and where rival firms are
                winning the cases.{" "}
              </p>
